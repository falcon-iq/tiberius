...
# -----------------------------------------------------------------------------
# Analyzer Service Discovery Entry
# Registers analyzer task IPs as analyzer.falcon-iq.local
# -----------------------------------------------------------------------------

resource "aws_service_discovery_service" "analyzer" {
  name = "analyzer"
  ...
  tags = {
    Name = "${local.name_prefix}-analyzer-discovery"
  }
}
