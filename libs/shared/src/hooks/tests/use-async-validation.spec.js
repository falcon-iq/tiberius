...
describe('useAsyncValidation', () => {
    const mockSuccessValidator = jest.fn(async (value, ctx) => {
        return { valid: true };
    });
    const mockFailureValidator = jest.fn(async (value, ctx) => {
        return { valid: false, error: 'Invalid value' };
    });
    const mockThrowingValidator = jest.fn(async (value, ctx) => {
    ...
    describe('basic validation', () => {
        it('should validate successfully', async () => {
            const { result } = renderHook(() => useAsyncValidation({
    ...
    describe('re-entrancy protection', () => {
        it('should cancel previous validation when new one starts', async () => {
            const slowValidator = jest.fn(async (value, ctx) => {
    ...
    describe('custom error message extraction', () => {
        it('should use extractErrorMessage function', async () => {
            ...
            const { result } = renderHook(() => useAsyncValidation({
                ...
                extractErrorMessage: (result) => result.details || result.error,
            }));
            await result.current.validate('test-value');
            await waitFor(() => {
